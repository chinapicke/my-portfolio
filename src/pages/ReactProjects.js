...
function ProjectCard(props) {
    ...
    return (
                <Card className= "maincardBody me-2 mb-5 pb-0" style={{ width: '40rem', height:'30rem' }}>
                    <Row>
                        <Col className="leftSideCard pt-3 pb-1 mb-2">
                        ...
                        <Col className="rightSideCard">
                            ...
                            <h1 className='thingsUsed'>React</h1>
                            <img src='/images/React-icon.svg.png' className="iconsUsed" alt='JS icon'></img>
                            <p className='describeUsed'>
                            Declarative, efficient, and flexible JavaScript <br></br>library for building reusable UI components</p>
                        </Col>
                    </Row>
                </Card>
    )
